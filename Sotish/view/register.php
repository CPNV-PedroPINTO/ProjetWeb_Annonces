                        ...
                        <div class="login_part_form_iner">
                            ...
                            <form class="form" action="index.php?action=register" method="post">
                                <div class="col-md-12 form-group p_star">
                                    <label for="userEmail"><b>Adresse email</b></label><input type="email" class="form-control" placeholder="Email address" name="registerInputUserEmailAddress" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <label for="userPsw"><b>Mot de passe</b></label><input type="password" class="form-control" id="password" name="registerPassword" value=""
                                           placeholder="Mot de passe">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <label for="psw-repeat"><b>Vérifier le mot de passe</b></label><input type="password" class="form-control" id="password" name="registerVerifyPassword" value=""
